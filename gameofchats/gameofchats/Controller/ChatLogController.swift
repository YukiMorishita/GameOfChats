...
class ChatLogController: UICollectionViewController, UICollectionViewDelegateFlowLayout, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    lazy var inputContainerView: ChatInputContainerView = {
        ...
        chatInputContainerView.frame = CGRect(x: 0, y: 0, width: self.view.frame.width, height: 50)
    ...
    fileprivate func handleVideoSelectedForUrl(_ url: URL) {
        ...
        let uploadTask = ref.putFile(from: url, metadata: nil, completion: { (_, error) in
            if let error = error {
                print("Failed to upload movie:", error)
                return
            }
    ...
    private func estimateFrameForText(text: String) -> CGRect {
        ...
        return NSString(string: text).boundingRect(with: size, options: options, attributes: [.font: UIFont.systemFont(ofSize: 16, weight: .regular)], context: nil)
    }
    ...
    func performZoomInForStartingImageView(_ startingImageView: UIImageView) {
        ...
        if let keyWindow = UIApplication.shared.keyWindow {
            ...
            NSLayoutConstraint.activate([
                blackBackgroundView!.topAnchor.constraint(equalTo: keyWindow.topAnchor),
                blackBackgroundView!.leftAnchor.constraint(equalTo: keyWindow.leftAnchor),
                blackBackgroundView!.rightAnchor.constraint(equalTo: keyWindow.rightAnchor),
                blackBackgroundView!.bottomAnchor.constraint(equalTo: keyWindow.bottomAnchor)
            ])
